...
The objective of this training class is to create an ERC20 token and create a contract in which you can deposit and withdraw your tokens.
The contracts I wrote are `MyErc20contract.sol`, `MyContract.sol` and the `1_td_deploy.js` migration file.

You can find out `MyContract.sol` in Rinkeby Network at : `0x14291d60A84C737B7D24d83d80A9e097445744cA`
